    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <img 
                ...
                className="w-10 h-10"
              />
              <h3 className="font-bold text-2xl text-white">EasyTech Durham</h3>
            </div>
          ...
          {/* Newsletter Signup */}
          <div>
            <h4 className="font-bold text-lg mb-4 text-white">Stay Tech-Savvy</h4>
            <p className="text-gray-300 mb-4">Get our free tips</p>
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <Input
                ...
                className="bg-white text-gray-900 border-gray-300 placeholder:text-gray-500 focus:border-accent"
                required
              />
              <Button 
                type="submit"
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-6 mb-4 md:mb-0">
              <a href="#" className="text-gray-300 hover:text-accent transition-all duration-300 transform hover:scale-110">
